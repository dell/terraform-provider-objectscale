...
// ServiceProviderGetResponse struct for ServiceProviderGetResponse
type ServiceProviderGetResponse struct {
	GetServiceProviderResult *ServiceProviderResult `json:"GetServiceProviderResult,omitempty"`
