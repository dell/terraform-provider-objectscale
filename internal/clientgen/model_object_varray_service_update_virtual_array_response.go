...
// ObjectVarrayServiceUpdateVirtualArrayResponse struct for ObjectVarrayServiceUpdateVirtualArrayResponse
type ObjectVarrayServiceUpdateVirtualArrayResponse struct {
	// Storage pool id
