...
// ObjectVarrayServiceCreateVirtualArrayResponse struct for ObjectVarrayServiceCreateVirtualArrayResponse
type ObjectVarrayServiceCreateVirtualArrayResponse struct {
	// Storage pool id
