...
type ApiIamServiceCreatePolicyRequest struct {
	ctx            context.Context
	ApiService     *IamApiService
	description    *string
	path           *string
...
func (r ApiIamServiceCreatePolicyRequest) Description(description string) ApiIamServiceCreatePolicyRequest {
	r.description = &description
	return r
}

// The path for the policy. Optional, defaults to \&quot;/\&quot; and only \&quot;/\&quot; is allowed.
func (r ApiIamServiceCreatePolicyRequest) Path(path string) ApiIamServiceCreatePolicyRequest {
	r.path = &path
	return r
}

// The policy document in JSON format.
func (r ApiIamServiceCreatePolicyRequest) PolicyDocument(policyDocument string) ApiIamServiceCreatePolicyRequest {
	r.policyDocument = &policyDocument
	return r
}

// Simple name identifying the policy.
func (r ApiIamServiceCreatePolicyRequest) PolicyName(policyName string) ApiIamServiceCreatePolicyRequest {
	r.policyName = &policyName
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceCreatePolicyRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceCreatePolicyRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceCreatePolicyRequest) Execute() (*IamServiceCreatePolicyResponse, *http.Response, error) {
	return r.ApiService.IamServiceCreatePolicyExecute(r)
}

/*
IamServiceCreatePolicy Create Managed Policy

Create Managed Policy

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceCreatePolicyRequest
*/
func (a *IamApiService) IamServiceCreatePolicy(ctx context.Context) ApiIamServiceCreatePolicyRequest {
	return ApiIamServiceCreatePolicyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceCreatePolicyResponse
func (a *IamApiService) IamServiceCreatePolicyExecute(r ApiIamServiceCreatePolicyRequest) (*IamServiceCreatePolicyResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceCreatePolicyResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceCreatePolicy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=CreatePolicy"
...
type ApiIamServiceCreatePolicyVersionRequest struct {
	ctx            context.Context
	ApiService     *IamApiService
	policyArn      *string
	policyDocument *string
...
// ARN of the IAM policy to add a new version.
func (r ApiIamServiceCreatePolicyVersionRequest) PolicyArn(policyArn string) ApiIamServiceCreatePolicyVersionRequest {
	r.policyArn = &policyArn
	return r
}

// The policy document in JSON format.
func (r ApiIamServiceCreatePolicyVersionRequest) PolicyDocument(policyDocument string) ApiIamServiceCreatePolicyVersionRequest {
	r.policyDocument = &policyDocument
	return r
}

// Specifies whether to set this version as the policy&#39;s default version.
func (r ApiIamServiceCreatePolicyVersionRequest) SetAsDefault(setAsDefault bool) ApiIamServiceCreatePolicyVersionRequest {
	r.setAsDefault = &setAsDefault
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceCreatePolicyVersionRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceCreatePolicyVersionRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceCreatePolicyVersionRequest) Execute() (*IamServiceCreatePolicyVersionResponse, *http.Response, error) {
	return r.ApiService.IamServiceCreatePolicyVersionExecute(r)
}

/*
IamServiceCreatePolicyVersion Create a new version of the specified managed policy.

Create a new version of the specified managed policy.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceCreatePolicyVersionRequest
*/
func (a *IamApiService) IamServiceCreatePolicyVersion(ctx context.Context) ApiIamServiceCreatePolicyVersionRequest {
	return ApiIamServiceCreatePolicyVersionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceCreatePolicyVersionResponse
func (a *IamApiService) IamServiceCreatePolicyVersionExecute(r ApiIamServiceCreatePolicyVersionRequest) (*IamServiceCreatePolicyVersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceCreatePolicyVersionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceCreatePolicyVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=CreatePolicyVersion"
	...
	if r.setAsDefault != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "SetAsDefault", r.setAsDefault, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *IamApiService) IamServiceCreateRoleExecute(r ApiIamServiceCreateRoleRequest) (*IamServiceCreateRoleResponse, *http.Response, error) {
	...
	if r.tagsMemberN != nil {
		for i, item := range *r.tagsMemberN {

			parameterAddToHeaderOrQuery(localVarQueryParams, fmt.Sprintf("Tags.member.%d.Key", i+1), item.Key, "")
			parameterAddToHeaderOrQuery(localVarQueryParams, fmt.Sprintf("Tags.member.%d.Value", i+1), item.Value, "")
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiIamServiceCreateSAMLProviderRequest struct {
	ctx                  context.Context
	ApiService           *IamApiService
	name                 *string
...
func (r ApiIamServiceCreateSAMLProviderRequest) Name(name string) ApiIamServiceCreateSAMLProviderRequest {
	r.name = &name
	return r
}

// An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document must be generated from  Organization&#39;s Identity Management software.
func (r ApiIamServiceCreateSAMLProviderRequest) SAMLMetadataDocument(sAMLMetadataDocument string) ApiIamServiceCreateSAMLProviderRequest {
	r.sAMLMetadataDocument = &sAMLMetadataDocument
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceCreateSAMLProviderRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceCreateSAMLProviderRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceCreateSAMLProviderRequest) Execute() (*IamServiceCreateSAMLProviderResponse, *http.Response, error) {
	return r.ApiService.IamServiceCreateSAMLProviderExecute(r)
}

/*
IamServiceCreateSAMLProvider Create SAML Identity Provider

Create SAML Identity Provider

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceCreateSAMLProviderRequest
*/
func (a *IamApiService) IamServiceCreateSAMLProvider(ctx context.Context) ApiIamServiceCreateSAMLProviderRequest {
	return ApiIamServiceCreateSAMLProviderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceCreateSAMLProviderResponse
func (a *IamApiService) IamServiceCreateSAMLProviderExecute(r ApiIamServiceCreateSAMLProviderRequest) (*IamServiceCreateSAMLProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceCreateSAMLProviderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceCreateSAMLProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=CreateSAMLProvider"
	...
	if r.sAMLMetadataDocument != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "SAMLMetadataDocument", r.sAMLMetadataDocument, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiIamServiceCreateUserRequest) TagsMemberN(tagsMemberN []IamTagKeyValue) ApiIamServiceCreateUserRequest {
	r.tagsMemberN = &tagsMemberN
	return r
}
...
type ApiIamServiceDeletePolicyRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	policyArn     *string
	xEmcNamespace *string
...
func (r ApiIamServiceDeletePolicyRequest) PolicyArn(policyArn string) ApiIamServiceDeletePolicyRequest {
	r.policyArn = &policyArn
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceDeletePolicyRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceDeletePolicyRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceDeletePolicyRequest) Execute() (*BasicResponse, *http.Response, error) {
	return r.ApiService.IamServiceDeletePolicyExecute(r)
}

/*
IamServiceDeletePolicy Delete Managed Policy

Delete Managed Policy

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceDeletePolicyRequest
*/
func (a *IamApiService) IamServiceDeletePolicy(ctx context.Context) ApiIamServiceDeletePolicyRequest {
	return ApiIamServiceDeletePolicyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return BasicResponse
func (a *IamApiService) IamServiceDeletePolicyExecute(r ApiIamServiceDeletePolicyRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceDeletePolicy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=DeletePolicy"
...
type ApiIamServiceDeletePolicyVersionRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	policyArn     *string
	versionId     *string
...
// ARN of the IAM Managed policy to delete.
func (r ApiIamServiceDeletePolicyVersionRequest) PolicyArn(policyArn string) ApiIamServiceDeletePolicyVersionRequest {
	r.policyArn = &policyArn
	return r
}

// The policy version to delete.
func (r ApiIamServiceDeletePolicyVersionRequest) VersionId(versionId string) ApiIamServiceDeletePolicyVersionRequest {
	r.versionId = &versionId
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceDeletePolicyVersionRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceDeletePolicyVersionRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceDeletePolicyVersionRequest) Execute() (*BasicResponse, *http.Response, error) {
	return r.ApiService.IamServiceDeletePolicyVersionExecute(r)
}

/*
IamServiceDeletePolicyVersion Delete a version of Managed Policy.

Delete a version of Managed Policy.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceDeletePolicyVersionRequest
*/
func (a *IamApiService) IamServiceDeletePolicyVersion(ctx context.Context) ApiIamServiceDeletePolicyVersionRequest {
	return ApiIamServiceDeletePolicyVersionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return BasicResponse
func (a *IamApiService) IamServiceDeletePolicyVersionExecute(r ApiIamServiceDeletePolicyVersionRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceDeletePolicyVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=DeletePolicyVersion"
...
type ApiIamServiceDeleteSAMLProviderRequest struct {
	ctx             context.Context
	ApiService      *IamApiService
...
// The ARN of the provider to delete.
func (r ApiIamServiceDeleteSAMLProviderRequest) SAMLProviderArn(sAMLProviderArn string) ApiIamServiceDeleteSAMLProviderRequest {
	r.sAMLProviderArn = &sAMLProviderArn
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceDeleteSAMLProviderRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceDeleteSAMLProviderRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceDeleteSAMLProviderRequest) Execute() (*IamServiceDeleteSAMLProviderResponse, *http.Response, error) {
	return r.ApiService.IamServiceDeleteSAMLProviderExecute(r)
}

/*
IamServiceDeleteSAMLProvider Delete the SAML Identity Provider.

Delete the SAML Identity Provider.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceDeleteSAMLProviderRequest
*/
func (a *IamApiService) IamServiceDeleteSAMLProvider(ctx context.Context) ApiIamServiceDeleteSAMLProviderRequest {
	return ApiIamServiceDeleteSAMLProviderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceDeleteSAMLProviderResponse
func (a *IamApiService) IamServiceDeleteSAMLProviderExecute(r ApiIamServiceDeleteSAMLProviderRequest) (*IamServiceDeleteSAMLProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceDeleteSAMLProviderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceDeleteSAMLProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=DeleteSAMLProvider"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if r.sAMLProviderArn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "SAMLProviderArn", r.sAMLProviderArn, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiIamServiceDeleteUserRequest) Execute() (*BasicResponse, *http.Response, error) {
...
//
//	@return BasicResponse
func (a *IamApiService) IamServiceDeleteUserExecute(r ApiIamServiceDeleteUserRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiIamServiceDeleteUserPermissionsBoundaryRequest) Execute() (*BasicResponse, *http.Response, error) {
...
//
//	@return BasicResponse
func (a *IamApiService) IamServiceDeleteUserPermissionsBoundaryExecute(r ApiIamServiceDeleteUserPermissionsBoundaryRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiIamServiceGetPolicyVersionRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	policyArn     *string
	versionId     *string
...
// ARN of the IAM Managed policy to retrieve.
func (r ApiIamServiceGetPolicyVersionRequest) PolicyArn(policyArn string) ApiIamServiceGetPolicyVersionRequest {
	r.policyArn = &policyArn
	return r
}

// Policy Version to retrieve.
func (r ApiIamServiceGetPolicyVersionRequest) VersionId(versionId string) ApiIamServiceGetPolicyVersionRequest {
	r.versionId = &versionId
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceGetPolicyVersionRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceGetPolicyVersionRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceGetPolicyVersionRequest) Execute() (*IamServiceGetPolicyVersionResponse, *http.Response, error) {
	return r.ApiService.IamServiceGetPolicyVersionExecute(r)
}

/*
IamServiceGetPolicyVersion Retrieve version of Managed Policy.

Retrieve version of Managed Policy.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceGetPolicyVersionRequest
*/
func (a *IamApiService) IamServiceGetPolicyVersion(ctx context.Context) ApiIamServiceGetPolicyVersionRequest {
	return ApiIamServiceGetPolicyVersionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceGetPolicyVersionResponse
func (a *IamApiService) IamServiceGetPolicyVersionExecute(r ApiIamServiceGetPolicyVersionRequest) (*IamServiceGetPolicyVersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceGetPolicyVersionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceGetPolicyVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=GetPolicyVersion"
...
type ApiIamServiceGetSAMLProviderRequest struct {
	ctx             context.Context
	ApiService      *IamApiService
	sAMLProviderArn *string
	xEmcNamespace   *string
...
func (r ApiIamServiceGetSAMLProviderRequest) SAMLProviderArn(sAMLProviderArn string) ApiIamServiceGetSAMLProviderRequest {
	r.sAMLProviderArn = &sAMLProviderArn
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceGetSAMLProviderRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceGetSAMLProviderRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceGetSAMLProviderRequest) Execute() (*IamServiceGetSAMLProviderResponse, *http.Response, error) {
	return r.ApiService.IamServiceGetSAMLProviderExecute(r)
}

/*
IamServiceGetSAMLProvider Retrieve the SAML IdP document.

Retrieve the SAML IdP document.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceGetSAMLProviderRequest
*/
func (a *IamApiService) IamServiceGetSAMLProvider(ctx context.Context) ApiIamServiceGetSAMLProviderRequest {
	return ApiIamServiceGetSAMLProviderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceGetSAMLProviderResponse
func (a *IamApiService) IamServiceGetSAMLProviderExecute(r ApiIamServiceGetSAMLProviderRequest) (*IamServiceGetSAMLProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceGetSAMLProviderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceGetSAMLProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=GetSAMLProvider"
...
type ApiIamServiceListPolicyVersionsRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	marker        *string
	maxItems      *int32
...
// For pagination, the value of the Marker element in the response that you received to indicate where the next call should start.
func (r ApiIamServiceListPolicyVersionsRequest) Marker(marker string) ApiIamServiceListPolicyVersionsRequest {
	r.marker = &marker
	return r
}

// Use this only when paginating results to indicate the maximum number of items you want in the response.  If additional items exist beyond the maximum you specify, the IsTruncated response element is true and  Marker contains a value to include in the subsequent call that tells the service where to continue from.
func (r ApiIamServiceListPolicyVersionsRequest) MaxItems(maxItems int32) ApiIamServiceListPolicyVersionsRequest {
	r.maxItems = &maxItems
	return r
}

// ARN of the IAM Managed policy to list.
func (r ApiIamServiceListPolicyVersionsRequest) PolicyArn(policyArn string) ApiIamServiceListPolicyVersionsRequest {
	r.policyArn = &policyArn
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceListPolicyVersionsRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceListPolicyVersionsRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceListPolicyVersionsRequest) Execute() (*IamServiceListPolicyVersionsResponse, *http.Response, error) {
	return r.ApiService.IamServiceListPolicyVersionsExecute(r)
}

/*
IamServiceListPolicyVersions List versions of IAM Managed Policy.

List versions of IAM Managed Policy.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceListPolicyVersionsRequest
*/
func (a *IamApiService) IamServiceListPolicyVersions(ctx context.Context) ApiIamServiceListPolicyVersionsRequest {
	return ApiIamServiceListPolicyVersionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceListPolicyVersionsResponse
func (a *IamApiService) IamServiceListPolicyVersionsExecute(r ApiIamServiceListPolicyVersionsRequest) (*IamServiceListPolicyVersionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceListPolicyVersionsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceListPolicyVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=ListPolicyVersions"
...
type ApiIamServiceListSAMLProvidersRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	marker        *string
	maxItems      *int32
...
// For pagination, the value of the Marker element in the response that you received to indicate where the next call should start.
func (r ApiIamServiceListSAMLProvidersRequest) Marker(marker string) ApiIamServiceListSAMLProvidersRequest {
	r.marker = &marker
	return r
}

// Use this only when paginating results to indicate the maximum number of items you want in the response.  If additional items exist beyond the maximum you specify, the IsTruncated response element is true and  Marker contains a value to include in the subsequent call that tells the service where to continue from.
func (r ApiIamServiceListSAMLProvidersRequest) MaxItems(maxItems int32) ApiIamServiceListSAMLProvidersRequest {
	r.maxItems = &maxItems
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceListSAMLProvidersRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceListSAMLProvidersRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceListSAMLProvidersRequest) Execute() (*IamServiceListSAMLProvidersResponse, *http.Response, error) {
	return r.ApiService.IamServiceListSAMLProvidersExecute(r)
}

/*
IamServiceListSAMLProviders List the SAML Identity Providers.

List the SAML Identity Providers.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceListSAMLProvidersRequest
*/
func (a *IamApiService) IamServiceListSAMLProviders(ctx context.Context) ApiIamServiceListSAMLProvidersRequest {
	return ApiIamServiceListSAMLProvidersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceListSAMLProvidersResponse
func (a *IamApiService) IamServiceListSAMLProvidersExecute(r ApiIamServiceListSAMLProvidersRequest) (*IamServiceListSAMLProvidersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceListSAMLProvidersResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceListSAMLProviders")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=ListSAMLProviders"
...
func (r ApiIamServicePutUserPermissionsBoundaryRequest) Execute() (*BasicResponse, *http.Response, error) {
...
//
//	@return BasicResponse
func (a *IamApiService) IamServicePutUserPermissionsBoundaryExecute(r ApiIamServicePutUserPermissionsBoundaryRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiIamServiceSetDefaultPolicyVersionRequest struct {
	ctx           context.Context
	ApiService    *IamApiService
	policyArn     *string
	versionId     *string
...
// ARN of the IAM Managed policy to set default version.
func (r ApiIamServiceSetDefaultPolicyVersionRequest) PolicyArn(policyArn string) ApiIamServiceSetDefaultPolicyVersionRequest {
	r.policyArn = &policyArn
	return r
}

// Policy Version to be set as default.
func (r ApiIamServiceSetDefaultPolicyVersionRequest) VersionId(versionId string) ApiIamServiceSetDefaultPolicyVersionRequest {
	r.versionId = &versionId
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceSetDefaultPolicyVersionRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceSetDefaultPolicyVersionRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceSetDefaultPolicyVersionRequest) Execute() (*BasicResponse, *http.Response, error) {
	return r.ApiService.IamServiceSetDefaultPolicyVersionExecute(r)
}

/*
IamServiceSetDefaultPolicyVersion set default version of Managed Policy.

set default version of Managed Policy.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceSetDefaultPolicyVersionRequest
*/
func (a *IamApiService) IamServiceSetDefaultPolicyVersion(ctx context.Context) ApiIamServiceSetDefaultPolicyVersionRequest {
	return ApiIamServiceSetDefaultPolicyVersionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return BasicResponse
func (a *IamApiService) IamServiceSetDefaultPolicyVersionExecute(r ApiIamServiceSetDefaultPolicyVersionRequest) (*BasicResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceSetDefaultPolicyVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=SetDefaultPolicyVersion"
...
func (r ApiIamServiceTagUserRequest) TagsMemberN(tagsMemberN []IamTagKeyValue) ApiIamServiceTagUserRequest {
	r.tagsMemberN = &tagsMemberN
	return r
}
...
func (a *IamApiService) IamServiceUntagRoleExecute(r ApiIamServiceUntagRoleRequest) (map[string]interface{}, *http.Response, error) {
	...
	if r.tagKeys != nil {
		for i, item := range *r.tagKeys {
			parameterAddToHeaderOrQuery(localVarQueryParams, fmt.Sprintf("TagKeys.member.%d", i+1), item.Key, "")
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiIamServiceUntagUserRequest) TagKeys(tagKeys []IamTagKey) ApiIamServiceUntagUserRequest {
	r.tagKeys = &tagKeys
	return r
}
...
type ApiIamServiceUpdateSAMLProviderRequest struct {
	ctx                  context.Context
	ApiService           *IamApiService
	sAMLProviderArn      *string
	sAMLMetadataDocument *string
...
// The ARN of the provider to update.
func (r ApiIamServiceUpdateSAMLProviderRequest) SAMLProviderArn(sAMLProviderArn string) ApiIamServiceUpdateSAMLProviderRequest {
	r.sAMLProviderArn = &sAMLProviderArn
	return r
}

// An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document must be generated from  Organization&#39;s Identity Management software.
func (r ApiIamServiceUpdateSAMLProviderRequest) SAMLMetadataDocument(sAMLMetadataDocument string) ApiIamServiceUpdateSAMLProviderRequest {
	r.sAMLMetadataDocument = &sAMLMetadataDocument
	return r
}

// ECS namespace IAM entity belongs to, only required when request performed by management user
func (r ApiIamServiceUpdateSAMLProviderRequest) XEmcNamespace(xEmcNamespace string) ApiIamServiceUpdateSAMLProviderRequest {
	r.xEmcNamespace = &xEmcNamespace
	return r
}

func (r ApiIamServiceUpdateSAMLProviderRequest) Execute() (*IamServiceUpdateSAMLProviderResponse, *http.Response, error) {
	return r.ApiService.IamServiceUpdateSAMLProviderExecute(r)
}

/*
IamServiceUpdateSAMLProvider Update the SAML Identity Provider.

Update the SAML Identity Provider.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIamServiceUpdateSAMLProviderRequest
*/
func (a *IamApiService) IamServiceUpdateSAMLProvider(ctx context.Context) ApiIamServiceUpdateSAMLProviderRequest {
	return ApiIamServiceUpdateSAMLProviderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return IamServiceUpdateSAMLProviderResponse
func (a *IamApiService) IamServiceUpdateSAMLProviderExecute(r ApiIamServiceUpdateSAMLProviderRequest) (*IamServiceUpdateSAMLProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *IamServiceUpdateSAMLProviderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamApiService.IamServiceUpdateSAMLProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam?Action=UpdateSAMLProvider"
