...
func (d *IAMUserDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description:         "This data source retrieves an Dell ObjectScale IAM user by name or ID and exposes key user attributes.",
		MarkdownDescription: "This data source retrieves an Dell ObjectScale IAM user by name or ID and exposes key user attributes.",
