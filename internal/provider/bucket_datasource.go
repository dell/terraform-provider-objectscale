...
func (d *BucketDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "This Data source Retrieves an ObjectScale S3 bucket by name and gives its configuration and metadata (namespace, owner etc.)",
		Description:         "This Data source Retrieves an ObjectScale S3 bucket by name and gives its configuration and metadata (namespace, owner etc.)",
